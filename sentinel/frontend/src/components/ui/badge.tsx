  ...
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        emerald: "border-transparent bg-emerald-50 text-emerald-600 border border-emerald-200",
        amber: "border-transparent bg-amber-50 text-amber-600 border border-amber-200",
      },
    },
    defaultVariants: {
      variant: "default",
